...
exports.GLOBAL_CONFIG = exports.TOKEN_RULE = exports.EL_TYPE = exports.REGEXP = void 0;
...
}), _defineProperty(_TOKEN_RULE, EL_TYPE['link'], DEFAULT_RULE.signleToken), _defineProperty(_TOKEN_RULE, EL_TYPE['!--'], DEFAULT_RULE.signleToken), _defineProperty(_TOKEN_RULE, EL_TYPE['input'], DEFAULT_RULE.signleToken), _defineProperty(_TOKEN_RULE, EL_TYPE['meta'], DEFAULT_RULE.signleToken), _defineProperty(_TOKEN_RULE, EL_TYPE['!----'], DEFAULT_RULE.signleToken), _TOKEN_RULE);
